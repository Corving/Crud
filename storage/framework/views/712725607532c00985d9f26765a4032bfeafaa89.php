    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="<?php echo e(route('accueil')); ?>">Accueil</a>
                </li>
                <li class="nav-item">
...
<?php /**PATH C:\Users\Alban\Documents\SynologyDrive\Cours\BTS\Développement\DEV\Laravel\Crud\resources\views/layouts/master.blade.php ENDPATH**/ ?>